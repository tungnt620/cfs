...
DROP POLICY update_self ON app_public.users;
DROP POLICY update_own ON app_public.confession_category;
DROP POLICY update_own ON app_public.confession;
DROP POLICY update_own ON app_public.comment;
DROP POLICY select_own ON app_public.user_emails;
DROP POLICY select_own ON app_public.user_confession_reaction;
DROP POLICY select_own ON app_public.user_comment_reaction;
DROP POLICY select_own ON app_public.user_authentications;
DROP POLICY select_all ON app_public.users;
DROP POLICY select_all ON app_public.confession_category;
DROP POLICY select_all ON app_public.confession;
DROP POLICY select_all ON app_public.comment;
DROP POLICY select_all ON app_public.category;
DROP POLICY manage_own ON app_public.user_confession_reaction;
DROP POLICY manage_own ON app_public.user_comment_reaction;
DROP POLICY manage_as_admin ON app_public.user_confession_reaction;
DROP POLICY manage_as_admin ON app_public.user_comment_reaction;
DROP POLICY manage_as_admin ON app_public.confession_category;
DROP POLICY manage_as_admin ON app_public.confession;
DROP POLICY manage_as_admin ON app_public.comment;
DROP POLICY manage_as_admin ON app_public.category;
DROP POLICY insert_own ON app_public.user_emails;
DROP POLICY insert_own ON app_public.confession_category;
DROP POLICY insert_own ON app_public.confession;
DROP POLICY insert_own ON app_public.comment;
DROP POLICY insert_all ON app_public.user_confession_reaction;
DROP POLICY insert_all ON app_public.user_comment_reaction;
DROP POLICY delete_own ON app_public.user_emails;
DROP POLICY delete_own ON app_public.user_authentications;
ALTER TABLE ONLY app_public.user_emails DROP CONSTRAINT user_emails_user_id_fkey;
ALTER TABLE ONLY app_public.user_confession_reaction DROP CONSTRAINT user_confession_reaction_user_id_fkey;
ALTER TABLE ONLY app_public.user_confession_reaction DROP CONSTRAINT user_confession_reaction_confession_id_fkey;
ALTER TABLE ONLY app_public.user_comment_reaction DROP CONSTRAINT user_comment_reaction_user_id_fkey;
ALTER TABLE ONLY app_public.user_comment_reaction DROP CONSTRAINT user_comment_reaction_comment_id_fkey;
ALTER TABLE ONLY app_public.user_authentications DROP CONSTRAINT user_authentications_user_id_fkey;
ALTER TABLE ONLY app_public.comment DROP CONSTRAINT fk_confession;
ALTER TABLE ONLY app_public.confession DROP CONSTRAINT confession_user_id_fkey;
ALTER TABLE ONLY app_public.confession_category DROP CONSTRAINT confession_category_confession_id_fkey;
ALTER TABLE ONLY app_public.confession_category DROP CONSTRAINT confession_category_category_id_fkey;
ALTER TABLE ONLY app_public.comment DROP CONSTRAINT comment_user_id_fkey;
ALTER TABLE ONLY app_public.comment DROP CONSTRAINT comment_parent_id_fkey;
ALTER TABLE ONLY app_private.user_secrets DROP CONSTRAINT user_secrets_user_id_fkey;
ALTER TABLE ONLY app_private.user_email_secrets DROP CONSTRAINT user_email_secrets_user_email_id_fkey;
ALTER TABLE ONLY app_private.user_authentication_secrets DROP CONSTRAINT user_authentication_secrets_user_authentication_id_fkey;
ALTER TABLE ONLY app_private.sessions DROP CONSTRAINT sessions_user_id_fkey;
DROP TRIGGER update_total_reaction ON app_public.user_confession_reaction;
DROP TRIGGER update_total_reaction ON app_public.user_comment_reaction;
DROP TRIGGER _900_send_verification_email ON app_public.user_emails;
DROP TRIGGER _500_verify_account_on_verified ON app_public.user_emails;
DROP TRIGGER _500_prevent_delete_last ON app_public.user_emails;
DROP TRIGGER _500_insert_secrets ON app_public.users;
DROP TRIGGER _500_insert_secrets ON app_public.user_emails;
DROP TRIGGER _500_gql_update ON app_public.users;
DROP TRIGGER _500_deletion_organization_checks_and_actions ON app_public.users;
DROP TRIGGER _500_audit_removed ON app_public.user_emails;
DROP TRIGGER _500_audit_removed ON app_public.user_authentications;
DROP TRIGGER _500_audit_added ON app_public.user_emails;
DROP TRIGGER _200_forbid_existing_email ON app_public.user_emails;
DROP TRIGGER _100_timestamps ON app_public.users;
DROP TRIGGER _100_timestamps ON app_public.user_emails;
DROP TRIGGER _100_timestamps ON app_public.user_confession_reaction;
DROP TRIGGER _100_timestamps ON app_public.user_comment_reaction;
DROP TRIGGER _100_timestamps ON app_public.user_authentications;
DROP TRIGGER _100_timestamps ON app_public.confession;
DROP TRIGGER _100_timestamps ON app_public.comment;
DROP TRIGGER _100_timestamps ON app_public.category;
DROP INDEX app_public.user_confession_reaction_user_id_idx;
DROP INDEX app_public.user_confession_reaction_confession_id_idx;
DROP INDEX app_public.user_comment_reaction_user_id_idx;
DROP INDEX app_public.user_comment_reaction_comment_id_idx;
DROP INDEX app_public.user_authentications_user_id_idx;
DROP INDEX app_public.uniq_user_emails_verified_email;
DROP INDEX app_public.uniq_user_emails_primary_email;
DROP INDEX app_public.idx_user_emails_user;
DROP INDEX app_public.idx_user_emails_primary;
DROP INDEX app_public.idx_confession_user;
DROP INDEX app_public.idx_comment_user;
DROP INDEX app_public.idx_category_slug;
DROP INDEX app_public.confession_category_confession_id_index;
DROP INDEX app_public.confession_category_category_id_index;
DROP INDEX app_public.comment_parent_id_idx;
DROP INDEX app_public.comment_confession_id_index;
DROP INDEX app_private.sessions_user_id_idx;
ALTER TABLE ONLY app_public.users DROP CONSTRAINT users_username_key;
ALTER TABLE ONLY app_public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY app_public.user_confession_reaction DROP CONSTRAINT user_id_confession_id_unique_key;
ALTER TABLE ONLY app_public.user_comment_reaction DROP CONSTRAINT user_id_comment_id_unique_key;
ALTER TABLE ONLY app_public.user_emails DROP CONSTRAINT user_emails_user_id_email_key;
ALTER TABLE ONLY app_public.user_emails DROP CONSTRAINT user_emails_pkey;
ALTER TABLE ONLY app_public.user_confession_reaction DROP CONSTRAINT user_confession_reaction_pkey;
ALTER TABLE ONLY app_public.user_comment_reaction DROP CONSTRAINT user_comment_reaction_pkey;
ALTER TABLE ONLY app_public.user_authentications DROP CONSTRAINT user_authentications_pkey;
ALTER TABLE ONLY app_public.user_authentications DROP CONSTRAINT uniq_user_authentications;
ALTER TABLE ONLY app_public.confession DROP CONSTRAINT confession_slug_key;
ALTER TABLE ONLY app_public.confession DROP CONSTRAINT confession_pkey;
ALTER TABLE ONLY app_public.confession_category DROP CONSTRAINT confession_category_confession_id_category_id_key;
ALTER TABLE ONLY app_public.comment DROP CONSTRAINT comment_pkey;
ALTER TABLE ONLY app_public.category DROP CONSTRAINT category_slug_key;
ALTER TABLE ONLY app_public.category DROP CONSTRAINT category_pkey;
ALTER TABLE ONLY app_private.user_secrets DROP CONSTRAINT user_secrets_pkey;
ALTER TABLE ONLY app_private.user_email_secrets DROP CONSTRAINT user_email_secrets_pkey;
ALTER TABLE ONLY app_private.user_authentication_secrets DROP CONSTRAINT user_authentication_secrets_pkey;
ALTER TABLE ONLY app_private.unregistered_email_password_resets DROP CONSTRAINT unregistered_email_pkey;
ALTER TABLE ONLY app_private.sessions DROP CONSTRAINT sessions_pkey;
ALTER TABLE ONLY app_private.connect_pg_simple_sessions DROP CONSTRAINT session_pkey;
ALTER TABLE app_public.user_confession_reaction ALTER COLUMN id DROP DEFAULT;
ALTER TABLE app_public.user_comment_reaction ALTER COLUMN id DROP DEFAULT;
ALTER TABLE app_public.confession ALTER COLUMN id DROP DEFAULT;
ALTER TABLE app_public.comment ALTER COLUMN id DROP DEFAULT;
ALTER TABLE app_public.category ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE app_public.user_confession_reaction_id_seq;
DROP TABLE app_public.user_confession_reaction;
DROP SEQUENCE app_public.user_comment_reaction_id_seq;
DROP TABLE app_public.user_comment_reaction;
DROP TABLE app_public.user_authentications;
DROP SEQUENCE app_public.confession_id_seq;
DROP TABLE app_public.confession_category;
DROP SEQUENCE app_public.comment_id_seq;
DROP SEQUENCE app_public.category_id_seq;
DROP TABLE app_public.category;
...
DROP TABLE app_private.unregistered_email_password_resets;
DROP TABLE app_private.connect_pg_simple_sessions;
DROP FUNCTION app_public.verify_email(user_email_id uuid, token text);
DROP FUNCTION app_public.users_has_password(u app_public.users);
DROP FUNCTION app_public.tg_users__deletion_organization_checks_and_actions();
DROP FUNCTION app_public.tg_user_emails__verify_account_on_verified();
DROP FUNCTION app_public.tg_user_emails__prevent_delete_last_email();
DROP FUNCTION app_public.tg_user_emails__forbid_if_verified();
DROP FUNCTION app_public.tg__graphql_subscription();
DROP FUNCTION app_public.resend_email_verification_code(email_id uuid);
DROP FUNCTION app_public.request_account_deletion();
DROP FUNCTION app_public.make_email_primary(email_id uuid);
DROP TABLE app_public.user_emails;
DROP FUNCTION app_public.logout();
DROP FUNCTION app_public.get_relative_confessions(target_confession_id integer);
DROP FUNCTION app_public.get_cfs_by_cat_slug(cat_slug character varying);
DROP FUNCTION app_public.get_cfs_by_cat(cat_id integer);
DROP FUNCTION app_public.forgot_password(email public.citext);
DROP FUNCTION app_public."current_user"();
DROP FUNCTION app_public.current_session_id();
DROP FUNCTION app_public.create_or_update_confession_reaction(confession_id integer, react_type app_public.reaction_type);
DROP FUNCTION app_public.create_or_update_comment_reaction(comment_id integer, react_type app_public.reaction_type);
DROP TABLE app_public.comment;
DROP FUNCTION app_public.create_cfs(title character varying, content character varying, slug character varying, cat_id integer, image character varying);
DROP TABLE app_public.confession;
DROP FUNCTION app_public.current_user_id();
DROP FUNCTION app_public.confirm_account_deletion(token text);
DROP FUNCTION app_public.change_password(old_password text, new_password text);
...
DROP FUNCTION app_private.tg__update_total_reaction();
DROP FUNCTION app_private.tg__timestamps();
DROP FUNCTION app_private.tg__add_job();
DROP FUNCTION app_private.tg__add_audit_job();
DROP FUNCTION app_private.reset_password(user_id uuid, reset_token text, new_password text);
DROP FUNCTION app_private.register_user(f_service character varying, f_identifier character varying, f_profile json, f_auth_details json, f_email_is_verified boolean);
...
DROP FUNCTION app_private.login(username public.citext, password text);
DROP TABLE app_private.sessions;
DROP FUNCTION app_private.link_or_register_user(f_user_id uuid, f_service character varying, f_identifier character varying, f_profile json, f_auth_details json);
DROP TABLE app_public.users;
DROP FUNCTION app_private.assert_valid_password(new_password text);
DROP TYPE app_public.reaction_type;
...
ALTER TABLE ONLY app_public.comment
    ADD CONSTRAINT comment_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES app_public.comment(id) ON DELETE CASCADE;
